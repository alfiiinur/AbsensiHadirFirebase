...
//        Icon(painter = painterResource(id = R.drawable.scho) , contentDescription ="icon")
...
fun PreviewLoginPage(){
    ...
    LoginPage(modifier = Modifier, navController = NavController(LocalContext.current), authViewModel = AuthViewModel() )
